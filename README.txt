...
3. Respecto a los cuellos de botella por parte del hardware en los tests de rendimiento, hemos dado por hecho que el máximo cuello de botella es la tarjeta de red.
Por ello en el documento se habla del siguiente cuello de botella que es la CPU.

4. Se han dividido los tests de rendimiento en 3 documentos, cada uno representa al equipo de hardware usado para los tests, en cada uno de ellos se puede ver las especificaciones, tanto del
