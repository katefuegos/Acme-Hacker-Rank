...
public class EducationDataHackerTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		final Object testingData[][] = {
				 ...
				 */
				{ degree, curriculaIdMine, "company1",
				 ...
				 * curricula ajena.
				 */
				{ degree, curriculaIdNotMine, "hacker",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 9.2. An actor who is
				 * authenticated as a company must be able to manage their
	...
	protected void templateCreateEducationData(final String degree,
		...
		try {
			...
			final EducationData educationData = this.educationDataService
					.create();
	...
	public void driverEdit() {
		...
		final Object testingData[][] = {
				 ...
				 */
				{ degree, educationDataIdMine, "company1",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 9.2. An actor who is
				 * authenticated as a company must be able to manage their
				 ...
				 */
				{ degree, educationDataIdNotMine, "hacker1",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 9.2. An actor who is
				 * authenticated as a company must be able to manage their
				 ...
				 * atributo degree.
				 */
				{ null, educationDataIdMine, "hacker1",
						javax.validation.ConstraintViolationException.class } 
				};
	...
	protected void templateEditEducationData(final String degree,
			final int educationDataId, final String username,
			final Class<?> expected) {
		Class<?> caught;
	...
	public void driverDelete() {
		...
		final Object testingData[][] = {
				 ...
				 */
				{ educationDataIdNotMine, "hacker1",
						java.lang.IllegalArgumentException.class }
		...
		for (int i = 0; i < testingData.length; i++)
			try {
				super.startTransaction();
				this.templateDeleteEducationData((int) testingData[i][0],
	...
	protected void templateDeleteEducationData(final int educationDataId,
