...
public class CurriculaTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		final Object testingData[][] = {
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated
			 * as a hacker must be able to manage his or her curricula. - Create. b) Positive test c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se crea curricula siendo hacker1.
			 */
			{
			...
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated
			 * as a hacker must be able to manage his or her curricula. -Create. b) Negative test -
			 * Business rule: it can't be created by a not hacker user c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se intenta crear problem siendo company1.
			 */
			{
			 ...
			 * a) Functional requirements - 17.1. An actor who is authenticated
			 * as a hacker must be able to manage his or her curricula. - Create. b) Negative test -
			 * Business rule: it can't be created without a fullName c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se intenta crear curricula siendo hacker1 sin atributo fullName.
			 */
			{
	...
	protected void templateCreateCurricula(final String fullName, final String username, final Class<?> expected) {
		...
		try {
			...
			final Hacker hacker = this.hackerService.findHackerByUsername(username);
	...
	public void driverEdit() {
		...
		final Object testingData[][] = {
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated
			 * as a hacker must be able to manage his or her curricula. - Edit. b) Positive test c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se edita curricula siendo hacker1.
			 */
			{
			...
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated
			 * as a hacker must be able to manage his or her curricula.- Edit. b) Negative test -
			 * Business rule: it can't be edited by a not hacker user c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se intenta editar curricula siendo hacker1.
			 */
			{
			 ...
			 * a) Functional requirements - 17.1. An actor who is authenticated
			 * as a hacker must be able to manage his or her curricula. - Edit. b) Negative test -
			 * Business rule: it can't be edited by a foreign c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se intenta editar curricula ajeno siendo hacker1.
			 */
			{
	...
	public void driverDelete() {
		...
		final Object testingData[][] = {
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated as a hacker
			 * must be able to manage his or her curricula. - Delete. b) Positive test c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se elimina curricula siendo hacker1.
			 */
			{
			...
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated as a hacker
			 * must be able to manage his or her curricula.. - Eliminar. b) Negative test -
			 * Business rule: it can't be deleted by a not company user c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se intenta eliminar curricula siendo company1.
			 */
			{
			...
			/*
			 * a) Functional requirements - 17.1. An actor who is authenticated as a hacker
			 * must be able to manage his or her curricula. - Delete. b) Negative test -
			 * Business rule: it can't be deleted by a foreign company c)
			 * analysis of sentence coverage: % d) analysis of data coverage
			 * - se intenta eliminar curricula ajeno siendo hacker1.
			 */
			{
