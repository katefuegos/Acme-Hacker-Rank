...
public class CurriculaHakerTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		final Object testingData[][] = {
				 ...
				 * coverage: % d) analysis of data coverage - se crea curricula
				 * siendo hacker1.
				 */
				{
				 ...
				 * coverage: % d) analysis of data coverage - se intenta crear
		...
		for (int i = 0; i < testingData.length; i++)
			try {
				...
				this.templateCreateCurricula((String) testingData[i][0],
	...
	protected void templateCreateCurricula(final String fullName,
	...
	public void driverEdit() {
		...
		final Object testingData[][] = {
				 ...
				 * coverage: % d) analysis of data coverage - se edita curricula
				 * siendo hacker1.
				 */
				 ...
				 * coverage: % d) analysis of data coverage - se intenta editar
				 * curricula siendo company1.
				 */
				{ fullName, curriculaIdMine, "company1",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 17.1. An actor who is
				 * authenticated as a hacker must be able to manage his or her
				 * curricula. - Edit. b) Negative test - Business rule: it can't
				 * be edited by a foreign c) analysis of sentence coverage: % d)
				 * analysis of data coverage - se intenta editar curricula ajeno
				 * siendo hacker1.
				 */
				{ fullName, curriculaIdNotMine, "hacker1",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 17.1. An actor who is
				 * authenticated as a hacker must be able to manage his or her
				 ...
				 * curricula siendo hacker1 sin atributo fullName.
				 */
				{ null, curriculaIdMine, "hacker1",
						javax.validation.ConstraintViolationException.class } };

		for (int i = 0; i < testingData.length; i++)
			try {
				super.startTransaction();
				this.templateEditCurricula((String) testingData[i][0],
	...
	protected void templateEditCurricula(final String fullName,
			final int curriculaId, final String username,
	...
	public void driverDelete() {
		...
		final Object testingData[][] = {
				 ...
				 * coverage: % d) analysis of data coverage - se elimina
				 ...
				 * sentence coverage: % d) analysis of data coverage - se
				 * intenta eliminar curricula siendo company1.
				 */
				{ curriculaIdMine, "company1",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 17.1. An actor who is
				 * authenticated as a hacker must be able to manage his or her
				 ...
				 * coverage: % d) analysis of data coverage - se intenta
				 * eliminar curricula ajeno siendo hacker1.
				 */
				{ curriculaIdNotMine, "hacker1",
						java.lang.IllegalArgumentException.class } };

		for (int i = 0; i < testingData.length; i++)
			try {
				super.startTransaction();
				this.templateDeleteCurricula((int) testingData[i][0],
						(String) testingData[i][1],
						(Class<?>) testingData[i][2]);
			} catch (final Throwable oops) {
				throw new RuntimeException(oops);
	...
	protected void templateDeleteCurricula(final int curriculaId,
			final String username, final Class<?> expected) {
		Class<?> caught;
